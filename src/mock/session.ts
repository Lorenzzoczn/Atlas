...
export const sessionUser: SessionUser = {
  ...
  firstName: "Lorenzzo",
  email: "lorenzzo@atlas-commerce.ai",
  role: "Proprietário",
  plan: "Scale",
  avatarHue: 248,
...
export const teamMembers = [
  { id: "tm_01", name: "Lorenzzo Cazani", email: "lorenzzo@atlas-commerce.ai", role: "Proprietário", status: "ativo" as const, lastSeen: "agora" },
  { id: "tm_02", name: "Marina Vasquez", email: "marina@atlas-commerce.ai", role: "Administradora", status: "ativo" as const, lastSeen: "há 12 min" },
  { id: "tm_03", name: "Otávio Prado", email: "otavio@atlas-commerce.ai", role: "Compras", status: "ativo" as const, lastSeen: "há 2 h" },
  { id: "tm_04", name: "Renan Delgado", email: "renan@atlas-commerce.ai", role: "Mídia paga", status: "ativo" as const, lastSeen: "há 1 d" },
  { id: "tm_05", name: "Camila Prates", email: "camila@atlas-commerce.ai", role: "Financeiro", status: "convidado" as const, lastSeen: "convite pendente" },
];
