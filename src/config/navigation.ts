  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Estoque",
        icon: Boxes,
        description: "Disponibilidade por anúncio e tipo logístico",
        keywords: ["inventário", "cd", "ruptura", "full", "flex"],
      },
      {
        href: "/envios",
        label: "Envios",
        icon: Truck,
        description: "Rastreio, transportadora e prazo de entrega",
        keywords: ["shipment", "logística", "entrega", "rastreio"],
      },
      {
        href: "/clientes",
        label: "Clientes",
